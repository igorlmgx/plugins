...
- (CozyMarkerElements *)cozyElementsFromData:(CozyMarkerData *)cozyMarkerData {
    ...
    CGFloat markerWidth = stringSize.width + (2 * paddingHorizontal) + (2 * self.strokeSize) + iconAdditionalWidth;
    ...
    CGFloat textX = (markerWidth / 2) - (stringSize.width / 2) + iconAdditionalWidth/2;
    ...
    return [[CozyMarkerElements alloc] initWithCanvas:[[CozyMarkerElement alloc] 
                                        ...
                                        bubble:[[CozyMarkerElement alloc] 
                                            initWithBounds:CGRectMake(bubbleShapeX, bubbleShapeY, bubbleShapeWidth, bubbleShapeHeight) 
                                            fillColor:markerColor 
                                            strokeColor:strokeColor 
                                            alpha:1 
                                            data:nil]
                                        labels:@[[[CozyMarkerElement alloc] 
                                            initWithBounds:CGRectMake(textX, textY, textWidth, textHeight) 
                                            fillColor:textColor 
                                            strokeColor:nil 
                                            alpha:1 
                                            data:text]]
